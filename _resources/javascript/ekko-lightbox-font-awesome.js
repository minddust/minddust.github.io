// shadow of ekko-lightbox which supports font-awesome icons
    ...
    if (!this.options.remote) {
      ...
      if (this.gallery) {
        ...
        if (this.options.directional_arrows && this.gallery_items.length > 1) {
          this.lightbox_container.prepend('<div class="ekko-lightbox-nav-overlay"><a href="#" class="arrow-left"><i class="fa fa-arrow-left"></i></a><a href="#" class="arrow-right"><i class="fa fa-arrow-right"></i></a></div>');
